...
const TestimonialSections = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <p className='md:text-base text-gray-500 mt-3'>Hear  from Our learners as they share their journy of transformation success and how our
        <br></br> platform has made a difference in their lives</p>
            ...
            <div key={index} className='text-sm text-left border border-gray-500/30 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden'>
              <div className=' flex items-center gap-4 px-5 py-4 bg-gray-500/10'>
                ...
                <div className='flex gap-0.5'>
                  {[...Array(5)].map((_, i)=>(
                    <img  className='h-5'key={i} src={i< Math.floor(Testimonials.rating)?
